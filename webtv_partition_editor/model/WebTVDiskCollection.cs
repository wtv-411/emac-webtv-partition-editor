...
namespace webtv_partition_editor
{
    public class WebTVDiskCollection : ObservableCollection<WebTVDisk> 
    {
        ...
        public void add_physical_disk(DiskWMIEntry wmi_disk)
        {
            this.add_disk(wmi_disk.open_disk());
        }

        public void add_disk_image(string image_path)
        {
        ...
        public void add_disk(WebTVDisk disk)
        {
