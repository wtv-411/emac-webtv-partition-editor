                            ...
                            if (parts != null && parts.Count > 0)
                            {
                                ...
                                if (last_index)
                                {
                                    ...
                                    for (int i = 0; i < (result_values.Length - 1); i++)
                                    {
                                        ...
                                        previous_size += Math.Floor(container_width * scaled_size);
                                    }

                                    partition_width = container_width - previous_size;
                                }
                                else
                                {
                                    Double scaled_size = result_values[selected_index] / results_sum;
                                    partition_width = Math.Floor(container_width * scaled_size);
                                }
